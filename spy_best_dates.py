...
# 최적 날짜 찾기
# ----------------------------
def find_top_dates(start_year: int, end_year: int,
    ...
    for m in range(1, 13):
        for d in range(1, 32):
            try:
                pd.Timestamp(year=2000, month=m, day=d)
            except ValueError:
                continue
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Find best SPY buy dates (1 or 2 times per year)")
