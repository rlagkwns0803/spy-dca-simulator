...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run SPY DCA sims for buys_per_year = 1..365 and rank by final value")
    ...
    parser.add_argument("--ticker", type=str, default="SPY", help="Ticker to simulate")
